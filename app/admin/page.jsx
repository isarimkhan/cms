...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { label: "Manage Courses", icon: <Book size={22} />, href: "/admin/manage-course" },
    { label: "Manage Teachers", icon: <Users size={22} />, href: "/admin/manage-teachers" },
    { label: "Manage Students", icon: <GraduationCap size={22} />, href: "/admin/manage-students" },
    { label: "View Reports", icon: <ClipboardList size={22} />, href: "/admin/view-reports" },
    { label: "Manage Users", icon: <Users size={22} />, href: "/admin/manage-users" },
    { label: "Assign Courses", icon: <Book size={22} />, href: "/admin/assign-courses" },
    { label: "Manage Roles", icon: <UserCog size={22} />, href: "/admin/manage-roles" },
    { label: "Analytics", icon: <BarChart3 size={22} />, href: "/admin/analytics" },
  ];
